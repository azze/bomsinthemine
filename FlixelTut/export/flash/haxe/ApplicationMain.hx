...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/fireball2.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/fireballa.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/fireballfull.png");
		types.push (AssetType.IMAGE);
		...
		urls.push ("assets/images/Game_Template_Miner_Trevor.png");
		types.push (AssetType.IMAGE);
		...
		urls.push ("assets/images/Trevor_Thumb_v1.png");
		types.push (AssetType.IMAGE);
		...
		urls.push ("assets/sounds/drop.wav");
		types.push (AssetType.SOUND);
		
		
		urls.push ("assets/sounds/Explosion.wav");
		types.push (AssetType.SOUND);
		
		
		urls.push ("assets/sounds/Hit_Hurt2.wav");
		types.push (AssetType.SOUND);
		
		
		urls.push ("assets/sounds/Jump3.wav");
		types.push (AssetType.SOUND);
		
		
		urls.push ("assets/sounds/Laser_Shoot14.wav");
		types.push (AssetType.SOUND);
